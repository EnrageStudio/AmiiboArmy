...
using AmiiboPedia.Models.Onboarding;
...
namespace AmiiboPedia.ViewModels.Onboarding
{
    /// <summary>
        ...
        public OnBoardingAnimationViewModel()
        {
            ...
            this.Boardings = new ObservableCollection<Boarding>
            {
                ...
                new Boarding()
                {
                    ...
                    Header = "Hola y gracias por probar mi aplicación.",
                    Content = "Revisa más detalles del desarrollo en enragestudio.com también podrás encontrar el lanzamiento de nuevos proyectos.",
                    RotatorItem = new WalkthroughItemPage()
                }
            };
